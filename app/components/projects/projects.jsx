        ...
        <section className={`${global.section} ${glow.glowBlueHoverProjects}`}>
            <div className={styles.container}>
                ...
                <div className={styles.grid}>
                    ...
                    <a href="https://food-next-js-seven.vercel.app/" className={`${styles.card} ${glow.glowPinkHover} ${styles.link}`} aria-label="Link to Food App" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://github.com/joesatriani10/Image-Recognition" className={`${styles.card} ${glow.glowPinkHover} ${styles.link}`} aria-label="Link to Image Recognition" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.speedofbytes.io/" className={`${styles.card} ${glow.glowPinkHover} ${styles.link}`} aria-label="Link to speedofbytes.io" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://cjdatacom.com/" className={`${styles.card} ${glow.glowPinkHover} ${styles.link}`} aria-label="Link to cjdatacom.com" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://login-form-next-ruby.vercel.app/" className={`${styles.card} ${glow.glowPinkHover} ${styles.link}`} aria-label="Link to Login" target="_blank" rel="noopener noreferrer">
